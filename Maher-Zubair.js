...
const whatsapp-ban = require('./whatsapp-ban'); // Import whatsapp.js for /whatsapp logic


// Define routes
app.use('/telegram', tele); // Use tele.js logic for /tele route
app.use('/whatsapp', whatsapp); // Use whatsapp.js logic for /whatsapp route
app.use('/whatsapp-ban', whatsapp-ban); // Use whatsapp.js logic for /whatsapp route
