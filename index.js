...
// Serve page.html for the /tools route
app.get('/giveaway', (req, res) => {
res.sendFile(__path + '/giveaway.html');
});

// Serve page.html for the /tools route
app.get('/speak', (req, res) => {
res.sendFile(__path + '/speak.html');
});

// Serve page.html for the /tools route
app.get('/ads', (req, res) => {
res.sendFile(__path + '/ads.html');
});
